...
file_Path = 'C:\\Piloerection\\data\\demo\\local\\post_pred\\origin'
smooth_save_Path = 'C:\\Piloerection\\data\\demo\\local\\post_pred\\smooth'
...
plot_Path = 'C:\\Piloerection\\data\\demo\\local\\post_pred\\plot'
