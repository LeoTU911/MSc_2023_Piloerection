...
### Main Function ###
def video2Img(one_Grid_videos_Path='', four_Grid_videos_Path='', save_Path='./'):
    ...
    if one_Grid_videos_Path:
        video2Img1Grid(filePath=one_Grid_videos_Path, save_path=save_Path, save_interval=1)
    # 4-Grid video to image
    if four_Grid_videos_Path:
        video2Img4Grid(filePath=four_Grid_videos_Path, save_path=save_Path, save_interval=1)
    
    end_time = time.time()
    time_spent = end_time - start_time
    print('video to frame image finished, images saved in {}, time spent: {}s'.format(save_Path, round(time_spent,4)))
...
four_Grid_videos_Path = 'C:\\Piloerection\\data\\demo\\local\\video'
save_Path = 'C:\\Piloerection\\data\\demo\\local\\frameImage'
video2Img(one_Grid_videos_Path='', four_Grid_videos_Path=four_Grid_videos_Path, save_Path=save_Path)
